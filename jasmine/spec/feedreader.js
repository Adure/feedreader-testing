...
$(function() {
    ...
    */
    ...
    describe('The Menu', function() {
        ...
        it('icon button functions properly', function() {
    ...
    describe('New Feed Selection', function() {
        const firstChild = $('.feed')[0].firstElementChild;
        ...
        it('ensure feed changes', function(done) {
            const firstChild2 = $('.feed')[0].firstElementChild;
            expect(firstChild2).not.toBe(firstChild);
            done();
        });
    });
}());
